...
- **`engine.test.ts`** — 712 assertions, all passing. Exact/hand-checkable, not approximate:
...
## Run it
```
node engine.test.ts            # expect: 712 passed, 0 failed (Node strips types at runtime)
