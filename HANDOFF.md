...
- **`engine.test.ts`** — 690 assertions, all passing. Exact/hand-checkable, not approximate:
...
## Run it
```
node engine.test.ts            # expect: 690 passed, 0 failed (Node strips types at runtime)
