...
- **`engine.test.ts`** — 696 assertions, all passing. Exact/hand-checkable, not approximate:
...
## Run it
```
node engine.test.ts            # expect: 696 passed, 0 failed (Node strips types at runtime)
