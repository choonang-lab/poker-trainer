...
- **`engine.test.ts`** — 679 assertions, all passing. Exact/hand-checkable, not approximate:
...
## Run it
```
node engine.test.ts            # expect: 679 passed, 0 failed (Node strips types at runtime)
