...
- **`engine.test.ts`** — 395 assertions, all passing. Exact/hand-checkable, not approximate:
...
## Run it
```
node engine.test.ts            # expect: 395 passed, 0 failed (Node strips types at runtime)
