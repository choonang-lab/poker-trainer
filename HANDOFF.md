...
- **`engine.test.ts`** — 687 assertions, all passing. Exact/hand-checkable, not approximate:
...
## Run it
```
node engine.test.ts            # expect: 687 passed, 0 failed (Node strips types at runtime)
