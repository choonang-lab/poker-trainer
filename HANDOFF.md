...
- **`engine.test.ts`** — 702 assertions, all passing. Exact/hand-checkable, not approximate:
...
## Run it
```
node engine.test.ts            # expect: 702 passed, 0 failed (Node strips types at runtime)
